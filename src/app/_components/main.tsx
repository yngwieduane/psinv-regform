        ...
        <main>
            ...
            >
                ...
                {/* <img
                    ...
                    src="/main-banner.png"
                    className="absolute inset-0 w-full h-full opacity-10 z-0 object-cover dark:hidden"
                />
                <img
                    alt="psi-list" title="psi-list"
                    src="/main-banner.png"
                    className="absolute inset-0 w-full h-full object-cover opacity-10 hidden dark:block z-0"
                /> */}
