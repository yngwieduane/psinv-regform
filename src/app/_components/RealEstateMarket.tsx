            ...
            <div className="md:flex gap-6 items-stretch w-full justify-between">
                <div className="md:w-2/3 w-full flex flex-col">
                    ...
                    <div className="grid gap-5 my-5">
                        <p className="text-[#333333] opacity-80 font-semibold text-xl">Madhmoun <span className={notosans.className}>(مضمون)</span>, meaning &quot;verified&quot; in Arabic, is Abu Dhabi&apos;s official digital Multiple Listing Service (MLS), launched by the Abu Dhabi Real Estate Centre (ADREC).</p>
