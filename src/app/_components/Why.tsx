        ...
        <div className="w-full py-15">
            <div className="container md:flex px-6 md:px-8 mx-auto items-center mb-7 gap-5">
                <div className="md:w-[75%]">
                    <h5 className="text-lg text-[#E35F27] font-semibold mb-3">Unlock Your Property Potential</h5>
            ...
            <div className="container px-6 md:px-10 md:flex mx-auto gap-5 items-center md:space-y-0 space-y-5 items-stretch">                
                <div className="md:w-1/3 text-[#fff] bg-[#17173B] p-5 rounded-lg space-y-5 flex-1">
                    ...
                    <p className="text-md leading-normal text-[#FFFFFF99]">We make sure your property gets noticed. From top real estate portals to 
                ...
                <div className="md:w-1/3 text-[#fff] bg-[#17173B] p-5 rounded-lg space-y-5 flex-1">
                    ...
                    <p className="text-md leading-normal  text-[#FFFFFF99]">At PSI, we provide a full suite of professional marketing services at no extra cost. 
                ...
                <div className="md:w-1/3 text-[#fff] bg-[#17173B] p-5 rounded-lg space-y-5 flex-1">
                    ...
                    <p className="text-md leading-normal  text-[#FFFFFF99]">Every property owner gets a dedicated account manager backed by PSI's advanced CRM system. 
